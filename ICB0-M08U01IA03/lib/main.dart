...
..add(Dog('Ja Morant', 'Memphis Grizzlies, TN, USA', 
        'PG - In 59 games, 17.6 ppg and 6.8 apg while shooting 49.1% overall and 36.7% on 3-pointers.', 'https://media.giphy.com/media/VIhbRqUAnU5FzaBlhY/giphy.gif'))
..add(Dog('Kendrick Nunn', 'Miami Heat, FL, USA',
        'G - In 62 games (all starts), Nunn averaged 15.6 points on 44.8% shooting (36.2% on 3-pointers) and was one of the biggest surprises of this rookie class.', 'https://media.giphy.com/media/YMMwN9ZVih0iDCqISI/giphy.gif'))

..add(Dog('Zion Williamson', 'New Orleans Pelicans, LA, USA',
        'F - Williamson finishes the season averaging 23.6 ppg and 6.8 rpg while shooting 58.9%.', 'https://media.giphy.com/media/8PpacnSSPCjMDJBpPS/giphy.gif'))
..add(Dog('Coby White', 'Chicago Bulls, IL, USA',
        ...
        , 'https://media.giphy.com/media/fqz7ykIwKAQMgX4mPo/giphy.gif'))
..add(Dog('RJ Barret', 'New York Knicks, NY, USA',
        ...
        , 'https://media.giphy.com/media/lPpqQDEkLQSlTB3xtP/giphy.gif'))
..add(Dog('Brandon Clarke','Memphis Grizzlies, TN, USA', 
        ...
        , 'https://media.giphy.com/media/iGong5n4i9YUMZaXZR/giphy.gif'))
..add(Dog('Michael Porter','Denver Nuggets, CO, USA', 
        ...
        , 'https://media.giphy.com/media/J2JP3ossu0kag7jGlJ/giphy.gif'))
..add(Dog('Terence Davis','Toronto Raptors, Canada', 
        ...
        , 'https://media.giphy.com/media/Y0JC3OW0Zpd8qSxvil/giphy.gif'))
..add(Dog('Tyler Herro','Miami Heat, FL, USA', 
        ...
        , 'https://media.giphy.com/media/w8LnTVLOgzpmeR2vKp/giphy.gif'))
..add(Dog('P.J. Washington','Charlotte Hornets, NC, USA', 
        ...
        , 'https://media.giphy.com/media/8gNHS71HhsQfraRrsu/giphy.gif'))
..add(Dog('Matisse Thybulle','Philadelphia 76ers, PA, USA', 
        ...
        , 'https://media.giphy.com/media/d5qp51dDBWxfCUNLKf/giphy.gif'));
